...
<div class=" my-3 col-5 justify-content-center d-flex align-items-center" style="margin: auto; height: 100vh"> 
    <form method="POST" action={{ route('checkRegister') }} id="register-form" style="width: 100%; position: relative;" class="border border-light py-3 px-3 form-submit">
        @csrf
        ...
        <x-form.group-input >
            ...
            <x-slot:input
                ...
                value="{{ old('password__confirmation') }}"
                type="password"
            >
            </x-slot:input>
        </x-form.group-input>
