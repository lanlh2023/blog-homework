            ...
            <div class="menu-list h-100  d-inline-block w-100 bg-dark px-3 py-3">
                @if (auth()->user()->hasRole('admin') ||
                    ...
                    <div class="menu-item d-flex align-items-center justify-content-around w-100 px-3 py-3 mb-2 w-100 text-center {{ request()->is('admin/post*') ? 'active' : '' }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" height="1.5em"
                ...
                @if (auth()->user()->hasRole('admin'))
                    <div class="menu-item d-flex align-items-center justify-content-around w-100 px-3 py-3 mb-2 w-100 text-center {{ request()->is('admin/user*') ? 'active' : '' }}"
                        style="border-radius: 10px">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" height="1em"
                            viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
                ...
                @endif
                @if (auth()->user()->hasRole('admin'))
                    <div class="menu-item d-flex align-items-center justify-content-around w-100 px-3 py-3 mb-2 w-100 text-center {{ request()->is('admin/role_user*') ? 'active' : '' }}"
                        style="border-radius: 10px">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" height="1em"
                            viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
                        ...
                        <a class="text-decoration-none" href="{{ route('admin.role_user.index') }}">
                            Role User</a>
                    </div>
                @endif
            </div>
